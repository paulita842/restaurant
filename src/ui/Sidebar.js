...
//la diferencia entre Link y NavLink es que en NavLink podemos usar un props que es activeClassName, que cuando pasamos el mouse por el texto seleccionado se sobrepone un cuadro de color que nos resalta el texto seleccionado.
const Sidebar = () => {
    return ( 

       <div className="md:w-2/5 xl:w-1/5 bg-gray-800">
           <div className="p-6">
                <p className="uppercase text-white text-2xl tracking-wide text-center font-bold">Restaurante Paulis</p>
